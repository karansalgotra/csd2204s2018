...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNE
    -> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNE;
...
select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m;
+--------------+------+-----------------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.code;;
+--------------+------+-----------------------+
| manufacturer | name | No. of items produced |
+--------------+------+-----------------------+
|            5 | Sony |                     9 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufaccturer group by manufacturer;
ERROR 1054 (42S22): Unknown column 'p.manufaccturer' in 'on clause'
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer group by manufacturer;
+--------------+-------------------+-----------------------+
| manufacturer | name              | No. of items produced |
+--------------+-------------------+-----------------------+
|            1 | Sony              |                     1 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer,4 group by manufacturer;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '4 group by manufacturer' at line 1
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer<4 group by manufacturer;
+--------------+------+-----------------------+
| manufacturer | name | No. of items produced |
+--------------+------+-----------------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer where m.code<4 group by manufacturer;
+--------------+-----------------+-----------------------+
| manufacturer | name            | No. of items produced |
+--------------+-----------------+-----------------------+
|            1 | Sony            |                     1 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer where m.code.2 group by manufacturer;
ERROR 1054 (42S22): Unknown column 'm.code.2' in 'where clause'
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer where m.code>2 group by manufacturer;
+--------------+-------------------+-----------------------+
| manufacturer | name              | No. of items produced |
+--------------+-------------------+-----------------------+
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer group by manufacturer having count(*)=2;
+--------------+-----------------+-----------------------+
| manufacturer | name            | No. of items produced |
+--------------+-----------------+-----------------------+
|            3 | Hewlett-Packard |                     2 |
...
MariaDB [csd2204s18]> select manufacturer, m.name, COUNT(*) "No. of items produced" FROM products as p INNER join manu as m on m.code=p.manufacturer IN(2,3) group by manufacturer;
+--------------+------+-----------------------+
| manufacturer | name | No. of items produced |
+--------------+------+-----------------------+
|            2 | Sony |                     3 |
...
MariaDB [csd2204s18]> selct products.code, product.name, manu.name
    -> from table1
    -> LEFT JOIN table2 ON products
    -> ON PRODUCTS.CODE = MANU.CODE;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'selct products.code, product.name, manu.name
from table1
LEFT JOIN table2 ON pro' at line 1
MariaDB [csd2204s18]> selct products.code, product.name, manu.name
    -> from table1
    -> ;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'selct products.code, product.name, manu.name
...
MariaDB [csd2204s18]> SELECT PRODUCTS.CODE, PRODUCTS.NAME
    -> FROM PRODUCTS
    -> ON PRODUCTS.CODE = MANU.CODE
    -> UNION
    ...
    -> RIGHT JOIN MANU 
    -> ON PRODUCTS.CODE = MANU.CODE;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'ON PRODUCTS.CODE = MANU.CODE
UNION
...
MariaDB [csd2204s18]> SELECT PRODUCTS.CODE, PRODUCTS.NAME, MANU.NAME 
    ...
    -> LEFT JOIN MANU 
    -> ON PRODUCTS.CODE = MANU.CODE
    -> UNIONSELECT PRODUCTS.CODE, PRODUCTS.NAME, MANU.NAME
    -> FROM PRODUCTS
    -> RIGHT JOIN MANU
    -> ON PRODUCTS.CODE = MANU.CODE;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'UNIONSELECT PRODUCTS.CODE, PRODUCTS.NAME, MANU.NAME
FROM PRODUCTS
RIGHT JOIN MAN' at line 5
MariaDB [csd2204s18]> SELECT PRODUCTS.CODE, PRODUCTS.NAME, MANU.NAME 
    -> FROM PRODUCTS 
    -> LEFT JOIN MANU 
    -> ON PRODUCTS.CODE = MANU.CODE
    ...
    -> RIGHT JOIN MANU
    -> ON PRODUCTS.CODE = MANU.CODE;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'FROM PRODUCTS 
RIGHT JOIN MANU
ON PRODUCTS.CODE = MANU.CODE' at line 6
