...
MariaDB [csd2204s18]> select jobs;
...
MariaDB [csd2204s18]> selct * from regions;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'selct * from regions' at line 1
MariaDB [csd2204s18]> select * from regions;
+-----------+-------------------------+
...
MariaDB [csd2204s18]> select * from job_history;
+-------------+------------+------------+------------+---------------+
...
MariaDB [csd2204s18]> select * from job_employees;
ERROR 1146 (42S02): Table 'csd2204s18.job_employees' doesn't exist
...
MariaDB [csd2204s18]> select salary form  employees where last_name LIKE 'Bul';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'employees where last_name LIKE 'Bul'' at line 1
MariaDB [csd2204s18]> select salary form  employees where last_name LIKE 'Bull';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'employees where last_name LIKE 'Bull'' at line 1
MariaDB [csd2204s18]> select salary form employees where last_name LIKE 'Bull';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'employees where last_name LIKE 'Bull'' at line 1
MariaDB [csd2204s18]> select salary form  employees where last_name LIKE 'Bull';
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'employees where last_name LIKE 'Bull'' at line 1
...
MariaDB [csd2204s18]> select department_id, department_id from departments where department_name LIKE 'IT%';
+---------------+---------------+
...
MariaDB [csd2204s18]> SELCT * FROM EMPLOYEES;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SELCT * FROM EMPLOYEES' at line 1
MariaDB [csd2204s18]> SELCT * FROM employees;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'SELCT * FROM employees' at line 1
MariaDB [csd2204s18]> SELECT * FROM employees;
+-------------+-------------+-------------+----------+--------------------+------------+------------+----------+----------------+------------+---------------+
...
MariaDB [csd2204s18]> slect first_name, last_name from employees where manager_id !=0;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'slect first_name, last_name from employees where manager_id !=0' at line 1
...
MariaDB [csd2204s18]> select lacation_id, country_id from locations where country_id = 'US';
ERROR 1054 (42S22): Unknown column 'lacation_id' in 'field list'
...
MariaDB [csd2204s18]> select department_id from departments where location_id IN (select location_id, country_id from locations where country_id = 'US');
ERROR 1241 (21000): Operand should contain 1 column(s)
MariaDB [csd2204s18]> select department_id from departments where location_id IN (select country_id from locations where country_id = 'US');
...
MariaDB [csd2204s18]> select first_name, last_name from employees where department_id !=0 and department_id IN (select department_id from departments where location_id IN (select location_id from locations where country_id = 'US'));
+-------------+-------------+
| first_name  | last_name   |
+-------------+-------------+
| Alexander   | Hunold      |
...
MariaDB [csd2204s18]> se;\lect avg(salary) from employees;
...
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near '\lect avg(salary) from employees' at line 1
...
MariaDB [csd2204s18]> select min_salary from jobd where job_id IN (select first_name, job_id from employees);
ERROR 1146 (42S02): Table 'csd2204s18.jobd' doesn't exist
...
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees where salary = (select min_salary jobs where job_id = IN(select job_id from employees));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN(select job_id from employees))' at line 1
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees where salary = (select min_salary from jobs where job_id = IN(select job_id from employees));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN(select job_id from employees))' at line 1
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees where salary IN (select min_salary from jobs where job_id = IN(select job_id from employees));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN(select job_id from employees))' at line 1
MariaDB [csd2204s18]> select first_name, last_name, salary, job_id from employees where salary IN (select min_salary from jobs where job_id = IN(select job_id from employees));
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'IN(select job_id from employees))' at line 1
MariaDB [csd2204s18]> 
...
MariaDB [csd2204s18]> select frist_name, last_name, salary, department_id from employees where salary > (select avg(salary) from employees) and department_id IN(select department_id from departments where department_name LIKE 'IT%');
